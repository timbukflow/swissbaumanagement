...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# place: http://ogp.me/ns/place#">
    <meta charset="utf-8">
    <title>Swiss Baumanagement | Projekte</title>
    <meta name="description" content="Swiss Baumanagement AG Projektübersicht">
        ...
        <div class="gridpro neubau">
            <div class="gridcontainer">
                <a href="neubau-efh-lehnstrasse-st-gallen">
                    <div class="description">
                        <h2 class="shortpro">Neubau EFH |  Lehnstrasse St. Gallen</h2>
                    </div>
                    <div class="imgc shortpro">
                        <div class="inview shortpro"></div>
        ...
        <div class="gridpro neubau">
            <div class="gridcontainer">
                <a href="neubau-mfh-weinfelderstrasse-amriswil.php">
                    <div class="description">
                        <h2 class="shortpro">Neubau 3 MFH | Weinfelderstrasse Amriswil</h2>
                    </div>
                    <div class="imgc shortpro">
                        <div class="inview shortpro"></div>
        ...
        <div class="gridpro neubau">
            <div class="gridcontainer">
                <a href="neubau-mfh-wiesenstrasse-goldach">
                    <div class="description">
                        <h2 class="shortpro">Neubau MFH | Wiesenstrasse Goldach</h2>
                    </div>
                    <div class="imgc shortpro">
                        <div class="inview shortpro"></div>
        ...
        <div class="gridpro umbau">
            <div class="gridcontainer">
                <a href="umbau-mfh-okenfinerstrasse-taegerwilen">
                    <div class="description">
                        <h2 class="shortpro">Umbau MFH | Okenfinerstrasse Tägerwilen</h2>
                    </div>
                    <div class="imgc shortpro">
                        <div class="inview shortpro"></div>
        ...
        <div class="gridpro neubau">
            <div class="gridcontainer">
                <a href="neubau-mfh-dorfstrasse-oberhelfenschwil">
                    <div class="description">
                        <h2 class="shortpro">Neubau MFH | Dorfstrasse Oberhelfenschwil</h2>
                    </div>
                    <div class="imgc shortpro">
                        <div class="inview shortpro"></div>
        ...
        <div class="gridpro neubau">
            <div class="gridcontainer">
                <a href="neubau-polygon-bottighofen">
                    <div class="description">
                        <h2 class="shortpro">Neubau | Polygon Bottighofen</h2>
                    </div>
                    <div class="imgc shortpro">
                        <div class="inview shortpro"></div>
        ...
        <div class="gridpro neubau">
            <div class="gridcontainer">
                <a href="neubau-mfh-gozenbergstrasse-gossau.php">
                    <div class="description">
                        <h2 class="shortpro">Neubau MFH | Gozenbergstrasse Gossau</h2>
                    </div>
                    <div class="imgc shortpro">
                        <div class="inview shortpro"></div>
        ...
        <div class="gridpro umbau">
            <div class="gridcontainer">
                <a href="umbau-mfh-konstanzerstrasse-kreuzlingen">
                    <div class="description">
                        <h2 class="shortpro">Umbau MFH | Konstanzerstrasse Kreuzlingen</h2>
                    </div>
                    <div class="imgc shortpro">
                        <div class="inview shortpro"></div>
        ...
        <div class="gridpro neubau">
            <div class="gridcontainer">
                <a href="neubau-mfh-rebenpark-arbon">
                    <div class="description">
                        <h2 class="shortpro">Neubau 3 MFH | Rebenpark Arbon</h2>
                    </div>
                    <div class="imgc shortpro">
                        <div class="inview shortpro"></div>
        ...
        <div class="gridpro neubau">
            <div class="gridcontainer">
                <a href="neubau-villa-rebenpark-arbon">
                    <div class="description">
                        <h2 class="shortpro">Neubau Villa | Rebenpark Arbon</h2>
                    </div>
                    <div class="imgc shortpro">
                        <div class="inview shortpro"></div>
        ...
        <div class="gridpro neubau">
            <div class="gridcontainer">
                <a href="neubau-mfh-buechenstrasse-staad">
                    <div class="description">
                        <h2 class="shortpro">Neubau MFH | Buechenstrasse Staad</h2>
                    </div>
                    <div class="imgc shortpro">
                        <div class="inview shortpro"></div>
        ...
        <div class="gridpro umbau">
            <div class="gridcontainer">
                <a href="umbau-mfh-bauhof-wittenbach">
                    <div class="description">
                        <h2 class="shortpro">Umbau MFH | Bauhof Wittenbach</h2>
                    </div>
                    <div class="imgc shortpro">
                        <div class="inview shortpro"></div>
